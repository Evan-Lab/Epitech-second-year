...
namespace nts {
    ...
    Tristate Nor_4001::compute(std::size_t pin)
    {
        ...
        return (Logic::compute_nor(state_1, state_2));
    }

    void Nor_4001::setLink(std::size_t pin, IComponent &other, std::size_t other_pin)
    {
