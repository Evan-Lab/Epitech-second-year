...
namespace nts {
    ...
    Tristate Nand_4011::compute(std::size_t pin)
    {
        ...
        return (Logic::compute_nand(state_1, state_2));
    }

    void Nand_4011::setLink(std::size_t pin, IComponent &other, std::size_t other_pin)
    {
